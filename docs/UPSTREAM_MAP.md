...
| Augmentation and preprocessing | [`det3d/datasets/pipelines/preprocess.py`](https://github.com/tianweiy/CenterPoint/blob/3cf7d870537e287c99b43b68636ea392a5e6f519/det3d/datasets/pipelines/preprocess.py) | Global augmentation, class selection, range filtering, and target assignment implemented; dataset pipeline integration pending |
