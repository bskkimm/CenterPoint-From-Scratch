...
| CenterHead decode and task merge | [`det3d/models/bbox_heads/center_head.py`](https://github.com/tianweiy/CenterPoint/blob/3cf7d870537e287c99b43b68636ea392a5e6f519/det3d/models/bbox_heads/center_head.py) | Dense decode fixture-tested; task-wise NMS orchestration implemented against the local oracle |
...
| Point and sweep loading | [`det3d/datasets/pipelines/loading.py`](https://github.com/tianweiy/CenterPoint/blob/3cf7d870537e287c99b43b68636ea392a5e6f519/det3d/datasets/pipelines/loading.py) | SDK-independent binary loading, filtering, transforms, and sweep ordering implemented; fixed-token parity pending |
| Augmentation and preprocessing | [`det3d/datasets/pipelines/preprocess.py`](https://github.com/tianweiy/CenterPoint/blob/3cf7d870537e287c99b43b68636ea392a5e6f519/det3d/datasets/pipelines/preprocess.py) | Class-balanced resampling, global augmentation, class selection, range filtering, and target assignment implemented; dataset pipeline integration pending |
| Batch collation | [`det3d/torchie/parallel/collate.py`](https://github.com/tianweiy/CenterPoint/blob/3cf7d870537e287c99b43b68636ea392a5e6f519/det3d/torchie/parallel/collate.py) | Typed voxel and six-task target collation implemented |
...
| BEV RPN neck | [`det3d/models/necks/rpn.py`](https://github.com/tianweiy/CenterPoint/blob/3cf7d870537e287c99b43b68636ea392a5e6f519/det3d/models/necks/rpn.py) | Implemented with complete state layout, shape, gradient, and checkpoint tests; official forward fixture pending |
| CenterHead modules | [`det3d/models/bbox_heads/center_head.py`](https://github.com/tianweiy/CenterPoint/blob/3cf7d870537e287c99b43b68636ea392a5e6f519/det3d/models/bbox_heads/center_head.py) | Six tasks, initialization, integrated loss, state layout, gradients, and checkpoint tests implemented; official forward fixture pending |
| Detector assembly | [`det3d/models/detectors/voxelnet.py`](https://github.com/tianweiy/CenterPoint/blob/3cf7d870537e287c99b43b68636ea392a5e6f519/det3d/models/detectors/voxelnet.py) | Boundary-complete VoxelNet assembly implemented with an injected sparse backend; `SpMiddleResNetFHD`, CUDA parity, and official intermediate parity pending |
| Rotated NMS adapter | [`det3d/core/bbox/box_torch_ops.py`](https://github.com/tianweiy/CenterPoint/blob/3cf7d870537e287c99b43b68636ea392a5e6f519/det3d/core/bbox/box_torch_ops.py) | Slow CPU correctness oracle implemented; production backend pending |
